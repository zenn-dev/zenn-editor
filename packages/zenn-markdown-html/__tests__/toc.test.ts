...
describe('generateToc', () => {
  ...
  describe('generate toc from real-world html', () => {
    const html =
    ...
    test('should generate correct number of toc', () => {
      expect(toc).toHaveLength(4);
    });
    test('should generate with correct tree structure', () => {
  ...
  `;
    ...
    test('should generate hierarchical structure of toc #1', () => {
      expect(toc[0]).toEqual({
        text: '1a',
        id: '1a',
        level: 1,
    ...
    test('should generate hierarchical structure of toc #2', () => {
  ...
  describe('headings in details/summary', () => {
    const html = `
    <h1 id="1a">1a</h1>
    <h2 id="1a-2a">1a-2a</h2>
    <h3 id="1a-2a-3a">1a-2a-3a</h3>
  ...
  describe('control characters', () => {
    ...
    test('should be trimmed in text()', () => {
      expect(toc[0]).toEqual({
        text: '1a',
        id: '1a',
        level: 1,
