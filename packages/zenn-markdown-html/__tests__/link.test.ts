...
describe('Linkify properly', () => {
  ...
  test('should convert links to card if prev elem is br', () => {
    ...
    expect(html).toEqual(
      `<p>foo<br style="display: none">\n<div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example.com" style="display: none" rel="nofollow">https://example.com</a></p>\n`
    );
  });
  ...
  test('should convert links to card if first element in p', () => {
    const html = markdownToHtml('foo\n\nhttps://example.com');
    expect(html).toEqual(
      `<p>foo</p>\n<p><div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example.com" style="display: none" rel="nofollow">https://example.com</a></p>\n`
    );
  });
  ...
  test('should convert links when previous and next elements are softbreaks', () => {
    const html = markdownToHtml('text\nhttps://example.com\ntext');
    expect(html).toEqual(
      '<p>text<br style="display: none">\n<div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example.com" style="display: none" rel="nofollow">https://example.com</a><br style="display: none">\ntext</p>\n'
    );
  });
  ...
  test('should convert links when the links are the start of the line and the next elements are softbreaks', () => {
    const html = markdownToHtml('\n\nhttps://example.com\ntext');
    expect(html).toEqual(
      '<p><div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example.com" style="display: none" rel="nofollow">https://example.com</a><br style="display: none">\ntext</p>\n'
    );
  });
  ...
  test('should convert links even when some links exist in the line, unless softbreaks exist before and after the each links', () => {
    ...
    expect(html).toEqual(
      '<p><div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample1.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example1.com" style="display: none" rel="nofollow">https://example1.com</a><br style="display: none">\n<a href="https://example2.com" rel="nofollow">https://example2.com</a> text<br>\ntext <a href="https://example3.com" rel="nofollow">https://example3.com</a><br style="display: none">\n<div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample4.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example4.com" style="display: none" rel="nofollow">https://example4.com</a><br style="display: none">\ntext</p>\n'
    );
  });
  ...
  test('should convert links even when some links exist in the line, when each links are separated by linebreaks', () => {
    ...
    expect(html).toEqual(
      '<p><div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample1.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example1.com" style="display: none" rel="nofollow">https://example1.com</a><br style="display: none">\n<div class="embed-zenn-link"><iframe src="https://asia-northeast1-zenn-dev-production.cloudfunctions.net/iframeLinkCard?url=https%3A%2F%2Fexample2.com" frameborder="0" scrolling="no" loading="lazy"></iframe></div><a href="https://example2.com" style="display: none" rel="nofollow">https://example2.com</a></p>\n'
    );
  });
